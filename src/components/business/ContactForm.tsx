 ...
 *
 * Het vlak heeft dezelfde roze kleur als de sectie en wordt begrensd door een
 * rand. Crème gaf te veel beige op de pagina en zwart paste niet bij de rest
 * (klant, 16 aug). De rand doet nu het scheidingswerk: een rechthoek kan niet
 * voor een leeg invoerveld worden aangezien, een losse horizontale streep wel,
 * en dat was de oorspronkelijke klacht. Alle tinten hieronder zijn afgestemd
 * op die roze ondergrond.
 */
const labelStijl =
  "block text-[11px] font-medium uppercase tracking-[0.2em] text-ink";
const veldStijl =
  "mt-3 w-full border-b border-ink/50 bg-transparent pb-2 text-ink transition-colors duration-300 placeholder:text-ink/65 focus:border-ink focus:outline-none";
    ...
    <section className="overflow-hidden bg-blush pb-14 pt-12 md:pb-20 md:pt-16">
      <Container>
        {/* Geen kopje en geen haarlijn boven dit formulier. De lijn las als
            ...
            Het formulier staat daarom in een omlijnd vlak. Zonder kopje en
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
          <div className="rounded-2xl border border-ink/50 p-7 sm:p-10 lg:col-span-7">
            {verzonden ? (
              <motion.div
              ...
              >
                ...
                <div>
                  ...
                  <select
                    ...
                    required
                    defaultValue=""
                    className={`${veldStijl} appearance-none rounded-none invalid:text-ink/65`}
                  >
