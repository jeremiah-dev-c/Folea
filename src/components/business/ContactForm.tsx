        ...
        <div className="mt-10 grid gap-12 md:mt-12 lg:grid-cols-12 lg:gap-16">
          <div className="lg:col-span-7">
            {verzonden ? (
              ...
              >
                <p className="font-display text-[clamp(1.6rem,5vw,3rem)] uppercase leading-[1.05] tracking-[0.02em] text-ink">
                  Bericht
                  <br />
                  verzonden
                </p>
                <p className="mt-6 max-w-md text-lg leading-relaxed text-ink/70">
                  Bedankt {naam.trim() || "voor je bericht"}. We reageren binnen
                  één tot twee werkdagen op {email.trim() || "je e-mailadres"}.
                </p>
                <RotatingBadge
              ...
              >
                {/* Het formulier leest als een brief: de velden lopen mee in de
                    zin in plaats van als losse hokjes onder elkaar te staan. */}
                ...
                <p className="mt-6 text-lg leading-[2.1] text-ink/80 sm:text-xl sm:leading-[2.1]">
                  ik ben{" "}
                  ...
                  <input
                    ...
                    // size laat het veld meegroeien met wat er getypt wordt,
                    // zonder dat er iets gemeten hoeft te worden.
                    size={Math.min(Math.max(naam.length + 1, 11), 24)}
                    className={veldStijl}
                  />{" "}
                ...
                <p className="mt-9 text-lg leading-[2.1] text-ink/80 sm:text-xl sm:leading-[2.1]">
                  ...
                  <input
                    ...
                    size={Math.min(Math.max(email.length + 1, 14), 28)}
                    className={veldStijl}
                  />
                </p>

                <div className="mt-10 flex flex-col gap-6 border-t border-ink/20 pt-6 sm:flex-row sm:items-center sm:justify-between">
                  {/* Voortgang in plaats van een knop die pas aan het eind
                      reageert: je ziet meteen hoeveel er nog mist. */}
                  <div className="flex items-center gap-4">
                    <div
                      className="h-px w-24 overflow-hidden bg-ink/20"
                      aria-hidden="true"
                    >
                      <motion.span
          ...
          {/* De foto hoort bij het formulier en niet als los blok bovenaan de
              ...
              de brief ernaast een stuk langer is. */}
          <motion.aside
          ...
          >
            {/* Onder lg staat de foto onder de brief; op volle breedte werd een
                2:3 beeld daar een blok van bijna 750px hoog. */}
