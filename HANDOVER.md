...
- `public/images/product-*.jpg` (6 productstills, nu allemaal 4:5 op 1920x2400) en `model-*.jpg` (16 modelfoto's, 2:3 staand, 1600x2400). De productstills zijn opnieuw uitgesneden vanaf de masters omdat de pot er veel te klein op stond: op `product-front` vulde die maar 8% van het beeld. Masters staan als `Folea-0xx.jpg` in `source-media/images/` (git-ignored).
